...
YS_TEST         = join(intermediate_dir, 'tes_seg_labels.npy')
YL_TEST        = join(intermediate_dir, 'trn_cls_labels.npy')
BBOX_TEST      = join(intermediate_dir, 'trn_bboxes.npy')
PROBE_TEST     = join(intermediate_dir, 'trn_probe_out.npy')
...
def preprocess_input(model, data_dir, areas, x_path, ys_path, yl_path, probe_path, 
                      cls_labels, loc_labels, bbox_labels, 
 load_from_npy,
                      load_probe_output
                      ):
